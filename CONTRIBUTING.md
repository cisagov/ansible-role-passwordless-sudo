...
issue](https://github.com/cisagov/ansible-role-passwordless-sudo/issues) in
...
request](https://github.com/cisagov/ansible-role-passwordless-sudo/pulls), you
...
```console
cd ansible-role-passwordless-sudo
pyenv virtualenv <python_version_to_use> ansible-role-passwordless-sudo
pyenv local ansible-role-passwordless-sudo
